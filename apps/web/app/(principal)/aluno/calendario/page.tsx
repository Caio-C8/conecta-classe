        ...
        <header className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-1">
              <button className="p-2 hover:bg-white rounded-full transition-colors text-gray-400 hover:text-gray-900">
                <ChevronLeft size={20} />
              </button>
              <button className="p-2 hover:bg-white rounded-full transition-colors text-gray-400 hover:text-gray-900">
              ...
              <div className="space-y-4">
                {events[selectedDay as keyof typeof events] ? (
                  events[selectedDay as keyof typeof events].map((ev, i) => (
                    <div
                      key={i}
                      className="bg-white p-6 rounded-[32px] border border-gray-50 shadow-sm flex items-start space-x-4"
                    >
                      <div
